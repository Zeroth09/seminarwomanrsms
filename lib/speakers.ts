...
export const speakers = [
    {
        ...
        experience: [
            'Psikiater Konsultan di RSUP Prof. dr. I.G.N.G Ngoerah',
            'Dosen di Fakultas Kedokteran Universitas Udayana',
            'Ketua Perhimpunan Dokter Spesialis Kedokteran Jiwa Indonesia (PDSKJI) Cabang Denpasar'
        ],
        education: [
            'Doktor Ilmu Kedokteran (S3) - Universitas Udayana',
            'Spesialis Kedokteran Jiwa (Sp.KJ) - Universitas Udayana',
            'Dokter Umum - Universitas Udayana'
        ],
        expertise: ['Kesehatan Jiwa Perempuan', 'Psikiatri Komunitas', 'Gangguan Cemas & Depresi']
    },
    {
        id: 'hellen-citra',
